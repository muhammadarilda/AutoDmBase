...
class Twitter:
    def __init__(self):
        ...
        self.init = tweepy.OAuthHandler(constants.CONSUMER_KEY, constants.CONSUMER_SECRET)
        self.init.set_access_token(constants.ACCSESS_KEY, constants.ACCSES_SECRET)
    ...
    def post_tweet_with_media(self, tweet, media_url):
        ...
        auth = OAuth1(client_key= constants.CONSUMER_KEY,
                      ...
                      resource_owner_secret= constants.ACCSES_SECRET,
                      resource_owner_key= constants.ACCSESS_KEY)
